...
public class RegisterPage extends Utility {
    ...
    public String verifyRegisterText() {
        Reporter.log("getting registretion Text"+RegisterText.toString()+"<br>");
    ...
    public void setFirstName(String fname) {
        ...
        Reporter.log("Enter fname"+fname+ " to first name field "+Firstname.toString() + "<br>");sendTextToElement(Firstname, fname);
    }
    ...
    public void setLastname(String Lname) {
        ...
        Reporter.log("Enter Lastname"+Lname+ " to  Lastname field "+lastname.toString() + "<br>");sendTextToElement(lastname, Lname);
    }
    ...
    public void setConfirmPassword(String confirmPassword) {
        Reporter.log("Enter confrompassword"+ confirmPassword+ " to confrompassword  field "+ConfirmPassword .toString() + "<br>");
    ...
    public String verifyYourRegisterCompletedText() {
        Reporter.log("getting registraction text from "+Yourregistrationcompleted.toString()+"<br>");
    ...
    public void clickOnCountinue(){
        Reporter.log("Clicking on countinue Button"+ countinue.toString()+ "<br>");
